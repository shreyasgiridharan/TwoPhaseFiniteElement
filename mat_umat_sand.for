...
c
      ...
      if (ndi.ne.3) then
c
c                write(1,*) 'ERROR: this UMAT can be used only for elm.'
c                write(1,*) 'with 3 direct stress/strain components'
c                write(1,*) 'noel = ',noel
                error=10
c
      endif
...
c          write(1,*) 'ERROR: nasvdim too small in UMAT'
          error=10
      endif
c
...
c	     write(1,*) 'Error in integration, noel ',noel
c	     write(1,*) 'Try to decrease the global step size'
	     call xit_h
      end if
c
c --------------------
...
c
        if(phi.le.zero) then
c       
c                write(1,*) 'ERROR: subroutine CHECK_PARMS:'
c                write(1,*) 'phi = ',phi
                error = 10
                return 
c
...
c                       	write(1,*) 'number of substeps ',ksubst,
...
c                              write(1,*) 'substep size ',DT_k,
c     &                             ' is too small, step rejected'
                              error=3
                              return
                 end if          
c                                       
...
c
      if (mode.eq.2) then
c        write(1,*) '==================================================='
c        write(1,*) 'ERROR: abaqus job failed during call of UMAT'
c        write(1,*) '==================================================='
c        write(1,*) 'state dump:'
c        write(1,*) 
      endif
c
...
c
      if (mode.eq.2) then
c        write(1,*) 'Co-ordinates of material point:'
c        write(1,104) 'x1 = ',coords(1),' x2 = ',coords(2),' x3 = ',
c     &    coords(3)
c        write(1,*) 
c        write(1,*) 'Material parameters:'
c        write(1,*) 
c        do i=1,nparms
c          write(1,105) 'prop(',i,') = ',parms(i)
c        enddo 
c        write(1,*)
c        write(1,102) 'No. of mean components:  ',ndi
c        write(1,102) 'No. of shear components: ',nshr
c        write(1,*)
      endif
c
...
c        write(1,*) 'Stresses:'
c        write(1,*) 
c        write(1,101) 'sigma(1) = ',y(1)
c        write(1,101) 'sigma(2) = ',y(2)
c        write(1,101) 'sigma(3) = ',y(3)
c        write(1,101) 'sigma(4) = ',y(4)
c        write(1,101) 'sigma(5) = ',y(5)
c        write(1,101) 'sigma(6) = ',y(6)
c        write(1,*) 
c        write(1,*) 'Strain increment:'
c        write(1,*) 
c        write(1,101) 'deps_np1(1) = ',deps_np1(1)
c        write(1,101) 'deps_np1(2) = ',deps_np1(2)
c        write(1,101) 'deps_np1(3) = ',deps_np1(3)
c        write(1,101) 'deps_np1(4) = ',deps_np1(4)
c        write(1,101) 'deps_np1(5) = ',deps_np1(5)
c        write(1,101) 'deps_np1(6) = ',deps_np1(6)
c        write(1,*) 
c        write(1,*) 'Time increment:'
c        write(1,*) 
c        write(1,108) 'dtime = ',dtime
c        write(1,*) 
c        write(1,*) 'Internal variables:'
c        write(1,*) 
c        write(1,109) 'del(1) = ',statev(1)
c        write(1,109) 'del(2) = ',statev(2)
c        write(1,109) 'del(3) = ',statev(3)
c        write(1,109) 'del(4) = ',statev(4)
c        write(1,109) 'del(5) = ',statev(5)
c        write(1,109) 'del(6) = ',statev(6)
c        write(1,109) 'void   = ',statev(7)
c        write(1,*) 
c        write(1,*) '==================================================='
